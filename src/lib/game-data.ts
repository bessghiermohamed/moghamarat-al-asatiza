...
export const CHARACTERS: Character[] = [
  {
    ...
    emoji: '⚔️',
    portrait: `${PORTRAIT}/ibrahim.png`,
  },
  {
    id: 'abdullah',
    name: 'عبد الله',
    classAr: 'حارس',
    portrait: `${PORTRAIT}/abdullah.png`,
  ...
  },
  {
    ...
    name: 'بوخلوة',
    classAr: 'ساحر',
    portrait: `${PORTRAIT}/boukhloua.png`,
  ...
  },
  {
    ...
    name: 'دعاء بن تمرة',
    classAr: 'ساحرة النار',
    portrait: `${PORTRAIT}/doua_bentemra.png`,
  ...
  },
  {
    ...
    name: 'دعاء بن صباحة',
    classAr: 'ساحرة الماء',
    portrait: `${PORTRAIT}/doua_bensabaha.png`,
  ...
  },
  {
    ...
    name: 'دعاء بن سعيدان',
    classAr: 'ساحرة الريح',
    portrait: `${PORTRAIT}/doua_bensaidan.png`,
  ...
  },
  {
    ...
    name: 'آية بوحلاسة',
    classAr: 'ملاك',
    portrait: `${PORTRAIT}/aya_bouhalassa.png`,
  ...
  },
  {
    ...
    name: 'آية بوبكر',
    classAr: 'شيطانة طيبة',
    portrait: `${PORTRAIT}/aya_boubaker.png`,
  ...
  },
  {
    ...
    name: 'بن يمينة',
    classAr: 'فارس',
    portrait: `${PORTRAIT}/benyamina.png`,
...
export const REGION_ENEMIES: Record<string, Enemy[]> = {
  ...
  city: [
    { name: 'لص الطريق', health: 35, damage: 15, goldReward: 15, emoji: '🦹', image: `${IMG}/city_thief.png` },
    { name: 'حارس فاسد', health: 50, damage: 12, goldReward: 18, emoji: '💂', image: `${IMG}/city_corrupt_guard.png` },
    { name: 'تاجر الغش', health: 25, damage: 8, goldReward: 25, emoji: '🤥', image: `${IMG}/city_fake_merchant.png` },
    { name: 'قاطع طريق', health: 45, damage: 18, goldReward: 20, emoji: '⚔️', image: `${IMG}/city_highwayman.png` },
  ],
  mountains: [
    { name: 'العملاق الحجري', health: 70, damage: 20, goldReward: 25, emoji: '🗿', image: `${IMG}/mountain_giant.png` },
    { name: 'التنين الصغير', health: 60, damage: 25, goldReward: 30, emoji: '🐲', image: `${IMG}/mountain_small_dragon.png` },
    { name: 'نسر الجبال', health: 40, damage: 15, goldReward: 15, emoji: '🦅', image: `${IMG}/mountain_eagle.png` },
  ],
  desert: [
    ...
    { name: 'رملة حية', health: 35, damage: 15, goldReward: 15, emoji: '🌀', image: `${IMG}/desert_sand_snake.png` },
  ...
  ocean: [
    ...
    { name: 'سمكة القرش السحرية', health: 55, damage: 25, goldReward: 25, emoji: '🦈', image: `${IMG}/ocean_magic_shark.png` },
    { name: 'حورية الغدر', health: 40, damage: 18, goldReward: 35, emoji: '🧜‍♀️', image: `${IMG}/ocean_siren.png` },
  ],
  castle: [
